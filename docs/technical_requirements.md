...
Проект, на который пользователь поставил лайк, добавляется в его личный список "Понравившиеся проекты". При убирании лайка с проекта, проект удаляется из списка.
